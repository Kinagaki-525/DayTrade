...
def test_event_gate_marks_missing_event_context_as_data_unavailable():
    payload = build_event_gate(
        market_research={"target_date": "2026-08-12", "previous_trading_day": "2026-08-11", "research_cutoff": "2026-08-12T20:00:00+09:00", "candidate_research": [{"ticker": "1234", "source_attempt_ids": [], "event_context": None}]},
    ...
    assert any(rule["result"] == "DATA_UNAVAILABLE" for rule in candidate["rule_evaluations"])
